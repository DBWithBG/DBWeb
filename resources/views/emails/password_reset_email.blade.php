                                            ...
                                            <table style="margin: 0 auto;" cellpadding="0" cellspacing="0" width="80%">
                                                <tr>
                                                    <td style="color:#187272;">
                                                        <br>
                                                        <br>
                                                        Nous avons reçu une demande de réinitialisation de votre mot de passe. Pour continuer, cliquez <a href="{{url('/password/reset/' . $token)}}">ici</a>
                                                        <br>
                                                        <br>
                                                    </td>
                                                </tr>
