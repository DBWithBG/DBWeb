                                            ...
                                            <table style="margin: 0 auto;" cellpadding="0" cellspacing="0" width="80%">
                                                <tr>
                                                    <td style="color:#187272;">
                                                        <br>
                                                        <br>
                                                        Votre compte deliverbag a bien été créé, pour compléter votre inscription, veuillez vous rendre <a href="{{url('/driver/confirmEmail?email=' . $driver->user->email . '&token=' . $token)}}">ici</a>
