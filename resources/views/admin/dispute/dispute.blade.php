                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="card">
                            ...
                            <form method="post" action="{{url('/backoffice/dispute/'. $dispute->id .'/update')}}">
                                <div class="card-body">
                                    ...
                                    <div class="row">
                                        <label class="col-sm-2 col-form-label label-checkbox">Statut</label>
                                        <div class="col-sm-10 checkbox-radios">

                                            <div class="form-check">
                                                <label class="form-check-label">
                                                    <input class="form-check-input" type="radio" name="status" value="Ouvert" {{$dispute->status == 'Ouvert' ? 'checked' : ''}}> Ouvert
                                                    <span class="circle">
                      <span class="check"></span>
                                            ...
                                            <div class="form-check">
                                                <label class="form-check-label">
                                                    <input class="form-check-input" type="radio" name="status" value="En cours de traitement" {{$dispute->status == 'En cours de traitement' ? 'checked' : ''}}> En cours de traitement
                                                    <span class="circle">
                      <span class="check"></span>
                    </span>
                                                </label>
                                            ...
                                            <div class="form-check">
                                                <label class="form-check-label">
                                                    <input class="form-check-input" type="radio" name="status" value="Fermé" {{$dispute->status == 'Fermé' ? 'checked' : ''}}> Fermé
                                                    <span class="circle">
                      <span class="check"></span>
                    </span>
                                                </label>
