                            ...
                            <form id="add_salle_form"
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-5">
                                            <div class="form-group">
                                                <textarea required name="postal_codes" class="form-control" style="height: 200px!important;">{{$price->postal_codes}}</textarea>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <label class="col-sm-5 col-form-label">Prix hors zone code postaux</label>
                                        <div class="col-sm-5">
                                            <div class="form-group">
                                                <input required type="number" step="0.01" name="price_hors_postal" value="{{$price->price_hors_postal}}" class="form-control">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
