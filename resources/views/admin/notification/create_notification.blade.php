                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="card">
                            ...
                            <form id="add_etablissement_form" method="POST" action="{{url('/backoffice/push/notification')}}"
                            ...
                            <div class="card-body">
                                ...
                                <h3>A qui voulez-vous envoyer la notification ?</h3>
                                <div class="col-md-12">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-10">
                                            <div class="form-group">
                                                <input required type="text" name="titre" class="form-control" value="">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
                                        ...
                                        <div class="col-sm-10">
                                            <div class="form-group">
                                                <textarea required type="text" name="contenu" class="form-control"></textarea>
                                            </div>
                                        </div>
                                    </div>
                                </div>
